...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2016 at 11:00 PM
...
(1, 'Skills Navigator was started with a vision to provide skill-based training to students who wanted to make a career in skills biased job sectors. The objective was to extend this training to the huge educated and potential manpower base in the rural areas. From that initial focus on Skills Development, Skills Navigator graduated to developing and delivering training programs in urban, semi–urban and rural areas.'),
(2, 'The vision of the organization is to skill and employ, 1 million people by the end of 2022, expanding into areas like.');
...
(1, 'At Skills Navigator, we do not talk about placements in absolute terms. For us placements are a part of the whole process. An important imbibed step in the complete cycle of employability, that’s what the placement process is to us. We rigorously work on our program content and methodology to make it in sync with the industrial demands vis-à-vis the local aspirations and a good placement record is just a byproduct of this rigor.'),
...
--
-- Table structure for table `pmkvy.desc`
--

CREATE TABLE IF NOT EXISTS `pmkvy.desc` (
  `ID` int(50) NOT NULL,
  `DESC` varchar(1000) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `pmkvy.desc`
--

INSERT INTO `pmkvy.desc` (`ID`, `DESC`) VALUES
(1, 'The recently approved <i>Pradhan Mantri Kaushal Vikas Yojana (PMKVY)</i>, is a flagship scheme for imparting skill training to youth, focusing on improved curricula, better pedagogy and trained instructors. The training includes soft skills, personal grooming.');

-- --------------------------------------------------------

--
-- Table structure for table `pmkvy.objective`
--

CREATE TABLE IF NOT EXISTS `pmkvy.objective` (
  `id` int(50) NOT NULL,
  `desc` varchar(1000) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `pmkvy.objective`
--

INSERT INTO `pmkvy.objective` (`id`, `desc`) VALUES
(1, 'The objective of this Scheme is to encourage skill development for youth by providing monetary rewards for successful completion of approved training programs.');

-- --------------------------------------------------------

--
-- Table structure for table `pmkvy.objective.points`
--

CREATE TABLE IF NOT EXISTS `pmkvy.objective.points` (
  `id` int(50) NOT NULL,
  `point` varchar(500) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `pmkvy.objective.points`
--

INSERT INTO `pmkvy.objective.points` (`id`, `point`) VALUES
(1, 'Encourage standardization in the certification process and initiate a process of creating a registry of skills Enable and mobilize a large number of Indian youth to take up skill training and become employable and earn their livelihood.'),
(2, 'Increase productivity of the existing workforce and align the training and certification to the needs of the country.'),
(3, 'Provide Monetary Awards for Skill Certification to boost employability and productivity of youth by incentivizing them for skill trainings Reward candidates undergoing skill training by authorized institutions at an average monetary reward of Rs. 8,000 (Rupees EightThousand) per candidate.'),
(4, 'Benefit to lakhs of youth.');
...
(1, 'dia has marked its presence as one of the fastest growing economies of the world. It is expected to rank amongst the world’s top three growth economies and amongst the top three manufacturing destinations by 2020. With the help of favourable demographic factors and sustained availability of quality workforce, our country is poised to make its imprint on global economy.'),
...
INSERT INTO `working_model_parent` (`id`, `point`) VALUES
(1, 'NSDC & SSC'),
(2, 'Norms, Policies & Monitoring'),
(3, 'Funding'),
(4, 'Qualification Packs & National Occupation Standards'),
(5, 'Qualification Packs & National Occupation Standards'),
...
--
-- Indexes for table `pmkvy.desc`
--
ALTER TABLE `pmkvy.desc`
  ADD PRIMARY KEY (`ID`);

--
-- Indexes for table `pmkvy.objective`
--
ALTER TABLE `pmkvy.objective`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pmkvy.objective.points`
--
ALTER TABLE `pmkvy.objective.points`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `pmkvy.desc`
--
ALTER TABLE `pmkvy.desc`
  MODIFY `ID` int(50) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `pmkvy.objective`
--
ALTER TABLE `pmkvy.objective`
  MODIFY `id` int(50) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `pmkvy.objective.points`
--
ALTER TABLE `pmkvy.objective.points`
  MODIFY `id` int(50) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
