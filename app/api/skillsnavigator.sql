...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2017 at 05:32 PM
...
CREATE TABLE `pmkvy_charecteristics` (
  `id` int(50) NOT NULL,
  `desc` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `pmkvy_char_points` (
  `id` int(50) NOT NULL,
...
CREATE TABLE `pmkvy_description` (
  `id` int(50) NOT NULL,
  `description` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `pmkvy_objective_points` (
...
CREATE TABLE `why_skills_nav_detail` (
  `id` int(50) NOT NULL,
  `desc` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `why_skills_nav_points` (
  `id` int(50) NOT NULL,
...
CREATE TABLE `working_model_parent` (
  `id` int(50) NOT NULL,
...
CREATE TABLE `working_skills_nav` (
  `id` int(11) NOT NULL,
